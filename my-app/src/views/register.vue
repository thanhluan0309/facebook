    ...
    <div id="example" class="login">
        <div class="Alldisplay">
            ...
            <div class="right">
                ...
                <input id="repassword" class="right-body right-body_password" type="password"
                    placeholder="Re-Password" />
                <button class="right-body right-body_btnlogin" @click="backtologin()" type="button">Back to
                    login</button>
                <a href="#">Forgotten password?</a>

                <button class="right-body right-body_btnCreate" @click="handleregister()" type="button">Create New
                    Acoount</button>
    ...
    methods: {
        ...
        async handleregister() {
            ...
            if(  document.getElementById('password').value !==  document.getElementById('repassword').value){
                return alert('password and repassword not confirm');
            }
            try {
                const config = {
                method: "POST",
